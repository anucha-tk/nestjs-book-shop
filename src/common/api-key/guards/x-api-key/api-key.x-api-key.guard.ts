  ...
  handleRequest<IApiKeyPayload = any>(
    ...
    if (err || !apiKey) {
      if (
        ...
        switch (statusCode) {
          case ENUM_API_KEY_STATUS_CODE_ERROR.API_KEY_NOT_FOUND_ERROR:
            throw new ForbiddenException({
              statusCode,
              message: 'apiKey.error.notFound',
            });
          case ENUM_API_KEY_STATUS_CODE_ERROR.API_KEY_IS_ACTIVE_ERROR:
            throw new ForbiddenException({
              statusCode,
              message: 'apiKey.error.inactive',
            });
          case ENUM_API_KEY_STATUS_CODE_ERROR.API_KEY_NOT_ACTIVE_YET_ERROR:
            throw new ForbiddenException({
              statusCode,
              message: 'apiKey.error.notActiveYet',
            });
          case ENUM_API_KEY_STATUS_CODE_ERROR.API_KEY_EXPIRED_ERROR:
            throw new ForbiddenException({
              statusCode,
