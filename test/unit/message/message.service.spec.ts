...
describe('MessageService', () => {
  ...
  describe('get', () => {
    it('should be success', async () => {
      const result: string | IMessage = await messageService.get('test.hello');

      jest.spyOn(messageService, 'get').mockReturnValueOnce(result as any);
  ...
  describe('getRequestErrorsMessage', () => {
    it('single message should be success', async () => {
      const result: IErrors[] = await messageService.getRequestErrorsMessage(
        validationError,
        ['en'],
      );
  ...
  describe('getImportErrorsMessage', () => {
    it('should be success', async () => {
      ...
      jest
        .spyOn(messageService, 'getImportErrorsMessage')
        .mockReturnValueOnce(result as any);
